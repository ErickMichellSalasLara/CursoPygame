...
while True: #Este es el bucle principal del juego, se ejecuta continuamente hasta que se cierre la ventana
    ...
    for i in range(100,700,100): #Los for loops nos serviran para ahorrar lineas de codigo para los dibujos
        pygame.draw.rect(screen, BLACK,( i , 230, 50,50)) #Aqui se dibuja un rectangulo
        pygame.draw.line(screen, GREEN, (i, 0), (i, 100), 5)
        pygame.draw.circle(screen, RED, (20, i), 50)
