...
sound = pygame.mixer.Sound("Pygame/imagenes/laser5.ogg") #Se carga el sonido del láser
hit_sound = pygame.mixer.Sound("Pygame/imagenes/Coin.wav")
hit_sound.set_volume(0.2) #Se ajusta el volumen del sonido de la colision
while not done:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN: #Si se presiona una tecla
            ...
            if event.key == pygame.K_SPACE:
                ...
                sound.play() #Se reproduce el sonido del láser
    ...
    for laser in laser_list:
        ...
        for meteor in meteor_hit_list:
            ...
            score += 1
            hit_sound.play() #Se reproduce el sonido de la colision
            print(score)
...
'''
NOTA: Los sonidos deben estar en formato .ogg o .wav,
y deben estar en la misma carpeta que el archivo .py
para que puedan ser cargados correctamente. En este ejemplo,
se utilizan dos sonidos: "laser5.ogg" para el disparo del láser y "Coin.wav"
para la colisión entre el láser y el meteoro.
Asegúrate de tener estos archivos de sonido en tu proyecto para que el código funcione correctamente.
'''